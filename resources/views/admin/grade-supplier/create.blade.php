...
@section('title', 'Tambah Grade Supplier')
    ...
    <div class="w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-6">
            <div class="flex items-center mb-2">
                ...
                <h1 class="text-2xl font-semibold text-gray-800">Tambah Grade Supplier</h1>
            </div>
            <p class="text-sm text-gray-600 ml-7">Isi form di bawah untuk menambahkan supplier grade baru</p>
        </div>

        <!-- Form Card -->
        <div class="bg-white border border-gray-200 rounded-lg shadow-sm">
            <form action="{{ route('grade-supplier.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <textarea name="description"
                              ...
                              placeholder="Masukkan deskripsi supplier (opsional)">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
