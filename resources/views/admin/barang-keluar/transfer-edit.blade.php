...
@section('title', 'Edit Transfer Internal')

@section('content')
    <div class="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-50 py-8">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-gray-900">Edit Transfer Internal</h1>
                <p class="mt-1 text-sm text-gray-600">Perbarui data transfer internal</p>
            </div>

            <div class="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
                <form action="{{ route('barang.keluar.transfer.update', $transfer->id) }}" method="POST" class="p-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label class="block font-semibold text-gray-700 mb-2">
                                    Dari Lokasi <span class="text-red-500">*</span>
                                </label>
                                ...
                                <p class="mt-2 text-sm text-gray-500">
                                    Stok tersedia (termasuk transaksi ini): <span class="font-semibold text-green-600">{{ number_format($availableStock, 2) }} gr</span>
                                </p>
                            </div>

                            <div>
                                <label class="block font-semibold text-gray-700 mb-2">
                                    Ke Lokasi <span class="text-red-500">*</span>
                                </label>
                        ...
                        <div>
                            ...
                            <textarea name="notes" rows="3"
                                class="w-full border border-gray-300 rounded-lg p-3 focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-none">{{ old('notes', $transfer->notes) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center gap-3 pt-6 border-t border-gray-200 mt-6">
                        ...
                        <button type="submit"
                            class="flex-1 inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-semibold rounded-lg hover:from-purple-700 hover:to-indigo-700 focus:ring-4 focus:ring-purple-300 transition-all shadow-lg">
                            Simpan Perubahan
                        </button>
                    </div>
                </form>
