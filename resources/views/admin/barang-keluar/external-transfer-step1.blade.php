                            ...
                            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                <form action="{{ route('barang.keluar.external-transfer.step1') }}" method="GET"
                                    ...
                                    <div class="flex gap-2">
                                        ...
                                        <a href="{{ route('barang.keluar.external-transfer.export', request()->query()) }}"
                                            class="flex items-center gap-1 px-4 py-2 bg-emerald-700 text-white text-sm font-medium rounded-md hover:bg-emerald-800 transition-colors">
