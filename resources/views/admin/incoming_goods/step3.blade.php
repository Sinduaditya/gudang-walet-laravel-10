        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-center">
                    ...
                    <div class="flex items-center">
                        <span
                            class="w-10 h-10 flex items-center justify-center rounded-full bg-blue-600 text-white font-medium">3</span>
                                ...
                                <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                                    ...
                                    <div class="bg-gray-50 rounded-md p-3 mb-4 space-y-2">
                                        <div class="flex justify-between text-sm">
                                            ...
                                            <span
                                                class="font-medium text-gray-900">{{ number_format($step2Data['berat_awal'][$grade->id] ?? 0) }}
                                                gr</span>
                                        </div>
                                        <div class="flex justify-between text-sm">
                                            <span class="text-gray-600">Kadar Air:</span>
                                            <span
                                                class="font-medium text-gray-900">{{ $step2Data['kadar_air'][$grade->id] ?? 0 }}%</span>
                                        </div>
                                    </div>

                                    <!-- Timbangan Gudang Input -->
                                    <div class="mb-3">
                                        <label for="berat_akhir_{{ $grade->id }}"
                                            class="block text-sm font-medium text-gray-700 mb-1">
                                            Timbangan Gudang (gram) <span class="text-red-500">*</span>
                                        </label>
                                        <input type="number" name="berat_akhir[{{ $grade->id }}]"
                                            id="berat_akhir_{{ $grade->id }}"
                                            value="{{ old('berat_akhir.' . $grade->id) }}" required min="0"
                                    ...
                                    <div id="selisih_{{ $grade->id }}" class="hidden">
                                        ...
                                        <div class="grid grid-cols-2 gap-2">
                                            ...
                                            <div class="p-2 rounded-md border border-gray-200 text-center">
                                                ...
                                                <div id="decimal_value_{{ $grade->id }}"
                                                    class="font-bold text-lg font-mono"></div>
                                            </div>

                                            <!-- Persentase -->
                                            <div class="p-2 rounded-md border border-gray-200 text-center">
                                                <div class="text-xs text-gray-500 mb-1">Persentase</div>
                                                <div id="percentage_value_{{ $grade->id }}" class="font-bold text-lg">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
