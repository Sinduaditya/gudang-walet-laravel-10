        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
                            ...
                            <div class="p-6 space-y-5">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="unloading_date" id="unloading_date"
                                        value="{{ old('unloading_date', date('Y-m-d')) }}" required
                                        class="w-full px-3 py-2.5 rounded-lg border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-20 transition-all">
                ...
                <div class="lg:col-span-3 bg-white rounded-lg shadow-sm border h-fit">
                    <div class="px-6 py-4 border-b sticky top-0 bg-white z-10 rounded-t-lg">
                        <div class="flex items-start justify-between">
                            ...
                            <div class="hidden ml-4" id="selectedCounter">
                                <div
                                    class="inline-flex items-center px-3 py-1.5 bg-blue-50 border border-blue-200 rounded-lg">
                        ...
                        <div class="mt-4">
                            <div class="relative">
                                <input type="text" id="gradeSearch" placeholder="Cari grade supplier..."
                    ...
                    <div class="p-6">
                        <!-- Grade Grid -->
                        <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4 max-h-[600px] overflow-y-auto pr-2 custom-scrollbar"
                            id="gradeGrid">
                            @foreach ($gradeSuppliers as $grade)
                                <label class="grade-item relative cursor-pointer group"
                                    ...
                                    <div
                                        class="border-2 border-gray-200 rounded-xl p-3 transition-all duration-200 peer-checked:border-blue-500 peer-checked:bg-blue-50 hover:border-gray-300 hover:shadow-md peer-checked:shadow-md">
                                        <!-- Image -->
                                        @if ($grade->image_url)
                                            <div class="w-full h-20 rounded-lg overflow-hidden mb-3 bg-gray-100">
                                                <img src="{{ asset('storage/' . $grade->image_url) }}"
                                                    alt="{{ $grade->name }}" class="w-full h-full object-cover">
                                            </div>
                                        @else
                                            <div
                                                class="w-full h-20 bg-gray-100 rounded-lg flex items-center justify-center mb-3">
                                        ...
                                        <!-- Name -->
                                        <p class="text-sm font-medium text-gray-900 text-center leading-snug">
                                            {{ $grade->name }}</p>
