        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-center">
                    ...
                    <div class="flex items-center">
                        <span
                            class="w-10 h-10 flex items-center justify-center rounded-full bg-blue-600 text-white font-medium">2</span>
                        <span class="ml-2 text-sm font-medium text-gray-900">Input Berat Nota</span>
                    </div>
                    <div class="w-24 h-0.5 bg-gray-300 mx-4"></div>
                    <div class="flex items-center">
                        <span
                            class="w-10 h-10 flex items-center justify-center rounded-full bg-gray-300 text-gray-500 font-medium">3</span>
            ...
            <form action="{{ route('incoming-goods.store-step2') }}" method="POST" novalidate>
                @csrf
                ...
                <div class="bg-white rounded-lg shadow-sm border mb-6">
                    <div class="px-6 py-4 border-b">
                        ...
                        <p class="text-sm text-gray-500 mt-1">Masukkan berat nota dari supplier dan kadar air untuk setiap
                            grade</p>
                    </div>
                    <div class="p-6">
                            ...
                            @foreach ($grades as $grade)
                                <div class="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                                    ...
                                    <div class="flex items-center mb-4">
                                        ...
                                        @else
                                            <div
                                                class="w-16 h-16 bg-gray-100 rounded-lg flex items-center justify-center mr-3">
                                    ...
                                    <!-- Berat Nota Input -->
                                    <div class="mb-4">
                                        <label for="berat_awal_{{ $grade->id }}"
                                            class="block text-sm font-medium text-gray-700 mb-1">
                                            Berat Nota (gram) <span class="text-red-500">*</span>
                                        </label>
                                        <input type="number" name="berat_awal[{{ $grade->id }}]"
                                            id="berat_awal_{{ $grade->id }}"
                                            value="{{ old('berat_awal.' . $grade->id) }}" required min="0"
                                            step="1" placeholder="Masukkan berat"
                                    ...
                                    <!-- Kadar Air Input -->
                                    <div>
                                        <label for="kadar_air_{{ $grade->id }}"
                                            class="block text-sm font-medium text-gray-700 mb-1">
                                            Kadar Air (%)
                                        </label>
                                        <input type="number" name="kadar_air[{{ $grade->id }}]"
                                            id="kadar_air_{{ $grade->id }}"
                                            value="{{ old('kadar_air.' . $grade->id) }}" {{-- required --}}
                                            min="0" max="100" step="0.1" placeholder="Masukkan kadar air"
                                            class="w-full rounded-md border border-gray-300 py-2 px-3 placeholder-gray-400 shadow-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500">
