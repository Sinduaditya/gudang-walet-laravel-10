    ...
    <div class="w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-6">
            <div class="flex items-center mb-2">
                ...
                <h1 class="text-2xl font-semibold text-gray-800">Tambah Lokasi Baru</h1>
            </div>
            <p class="text-sm text-gray-600 ml-7">Isi form di bawah untuk menambahkan lokasi baru</p>
        </div>
            ...
            <div class="flex items-start">
                ...
                <div>
                    ...
                    <p class="text-sm text-blue-700">
                        Pastikan nama lokasi yang Anda masukkan unik dan mudah diidentifikasi. 
...
<script>
    ...
    document.querySelector('form')?.addEventListener('submit', function(e) {
        ...
        if (!confirm('Apakah Anda yakin ingin menyimpan lokasi ini?')) {
            e.preventDefault();
            return false;
        }
    });
