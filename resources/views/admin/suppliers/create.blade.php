    ...
    <div class="w-full px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-6">
            <div class="flex items-center mb-2">
                ...
                <h1 class="text-2xl font-semibold text-gray-800">Tambah Supplier Baru</h1>
            </div>
            <p class="text-sm text-gray-600 ml-7">Isi form di bawah untuk menambahkan supplier baru</p>
        </div>
            ...
            <div class="flex items-start">
                ...
                <div>
                    ...
                    <p class="text-sm text-blue-700">
                        Pastikan data supplier yang Anda masukkan akurat dan lengkap. 
...
<script>
    ...
    document.querySelector('form')?.addEventListener('submit', function(e) {
        ...
        if (!confirm('Apakah Anda yakin ingin menyimpan supplier ini?')) {
            e.preventDefault();
            return false;
        }
    });
