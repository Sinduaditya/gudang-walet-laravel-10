            ...
            <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-6 mb-8">
                <form method="GET" action="{{ route('tracking-stock.susut', $grade->id) }}">
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                        ...
                        <div>
                            <label for="from_location_id" class="block text-sm font-medium text-gray-700 mb-1">Dari
                                Lokasi</label>
                        ...
                        {{-- Filter 3: Ke Lokasi --}}
                        <div>
                            <label for="to_location_id" class="block text-sm font-medium text-gray-700 mb-1">Ke
                                Lokasi</label>
                        ...
                        <div class="flex gap-2">
                            <button type="submit"
                                class="px-6 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm font-medium transition duration-200 flex-1 md:flex-none justify-center">
                                Filter
                            </button>
                            ...
                            @forelse($stockTransfers as $index => $transfer)
                                <tr class="hover:bg-blue-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span
                                            class="text-sm font-bold {{ $transfer->susut_grams > 0 ? 'text-red-600' : 'text-gray-700' }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm">
                                        <div class="flex items-center">
                                            <span
                                                class="text-gray-700 font-medium bg-gray-100 px-2 py-0.5 rounded border border-gray-200">
                                                {{ $transfer->fromLocation->name ?? 'Unknown' }}
                                            </span>

                                            <svg class="w-4 h-4 mx-3 text-gray-400" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                            ...
                                            <span
                                                class="text-green-700 font-bold bg-green-50 px-2 py-0.5 rounded border border-green-100">
