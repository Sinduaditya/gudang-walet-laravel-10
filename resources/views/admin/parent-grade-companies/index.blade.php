...
@section('title', 'Manajemen Parent Grade Company')
    ...
    <div class="bg-white min-h-screen">
        <div class="w-full px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-semibold text-gray-800">Manajemen Parent Grade Company</h1>
                <a href="{{ route('parent-grade-companies.export') }}"
            ...
            <div class="mb-6">
                ...
                <div class="bg-gray-50 border border-gray-200 rounded-lg p-4">
                    <form method="GET" action="{{ route('parent-grade-companies.index') }}">
                        <div class="flex flex-col lg:flex-row gap-4">
                            ...
                            <div class="flex items-end gap-2">
                                ...
                                <!-- Add Button -->
                                <a href="{{ route('parent-grade-companies.create') }}"
            ...
            <div class="bg-white border border-gray-200 rounded-lg overflow-hidden">
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200" id="parentGradeCompanyTable">
                                ...
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-center text-sm">
                                        <div class="flex items-center justify-center space-x-2">
                                            <a href="{{ route('parent-grade-companies.edit', $item->id) }}"
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-12 text-center text-sm text-gray-500">
                                        @if (request('search'))
                                            Tidak ada data Parent Grade Company yang sesuai dengan pencarian
                                            "{{ request('search') }}".
                                        @else
                    ...
                    <div class="bg-white px-6 py-4 border-t border-gray-200">
                        <div class="flex items-center justify-between">
                            <div class="text-sm text-gray-700">
                                Showing {{ $parentGradeCompanies->firstItem() }}-{{ $parentGradeCompanies->lastItem() }} of
                                {{ $parentGradeCompanies->total() }} results
                            </div>
                            <div>
    ...
    <div id="deleteModal" class="hidden fixed inset-0 bg-black bg-opacity-50 overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
            <div class="mt-3 text-center">
                ...
                <h3 class="text-lg font-medium text-gray-900 mt-4">Hapus Parent Grade Company</h3>
                <p class="text-sm text-gray-500 mt-2">
                    Apakah Anda yakin ingin menghapus
                    <span id="itemName" class="font-semibold text-gray-900"></span>?
    ...
    @push('scripts')
        <script>
            ...
            function confirmDelete(id, name) {
                const baseUrl = `{{ route('parent-grade-companies.destroy', ':id') }}`;
