    ...
    <div class="bg-white rounded-lg shadow-md border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
            ...
            <a href="{{ route('barang.keluar.transfer-idm.index') }}"
               class="h-10 px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 flex items-center justify-center">
                Kembali
            </a>
        </div>
        <div class="p-6">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach($transfer->details as $index => $detail)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $detail->weight }} g</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
