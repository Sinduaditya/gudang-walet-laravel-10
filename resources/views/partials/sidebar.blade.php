<div class="bg-white text-gray-800 w-64 min-h-screen flex flex-col shadow-lg border-r border-gray-200">
    ...
    <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
        ...
        @php
            ...
            $isOperasionalActive = $isBarangMasuk || $isSortMaterials || $isGrading || $isManajemenIdm || $isBarangKeluar;
            $isMasterActive = $isMasterGradeCompany || $isMasterSupplier || $isMasterGradeSupplier || $isMasterLokasi || $isMasterParentGradeCompany;
        @endphp
        ...
        {{-- Operasional Group --}}
        <div class="pt-2">
            <button type="button" onclick="toggleMenu('operasional-menu', 'operasional-arrow')"
                class="w-full flex items-center px-4 py-3 rounded-lg transition-all duration-200 text-gray-600 hover:bg-gray-50 hover:text-gray-800 group">
                <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                </svg>
                <span class="font-medium flex-1 text-left">Operasional</span>
                <svg id="operasional-arrow" class="w-4 h-4 transition-transform duration-200 {{ $isOperasionalActive ? 'rotate-90' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                </svg>
            </button>

            <div id="operasional-menu" class="space-y-1 ml-4 {{ $isOperasionalActive ? '' : 'hidden' }}">
                <a href="{{ route('incoming-goods.index') }}"
                    class="flex items-center px-4 py-2.5 rounded-lg transition-all duration-200
                ...
                <a href="{{ route('sort-materials.index') }}"
                    class="flex items-center px-4 py-2.5 rounded-lg transition-all duration-200
                    {{ $isSortMaterials ? 'bg-orange-50 text-orange-600 font-semibold shadow-sm' : 'text-gray-600 hover:bg-gray-50 hover:text-gray-800' }}">
                    <svg class="w-4 h-4 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                    </svg>
                    <span class="text-sm font-medium">Sortir Bahan</span>
                </a>
                ...
                <a href="{{ route('grading-goods.index') }}"
                    ...
                    <span class="text-sm font-medium">Manajemen Grading</span>
                </a>
                ...
                <a href="{{ route('manajemen-idm.index') }}"
                    ...
                    <span class="text-sm font-medium">Manajemen IDM</span>
                </a>
        ...
        {{-- Master Data Group --}}
        <div class="pt-2">
            <button type="button" onclick="toggleMenu('master-menu', 'master-arrow')"
                class="w-full flex items-center px-4 py-3 rounded-lg transition-all duration-200 text-gray-600 hover:bg-gray-50 hover:text-gray-800 group">
                <svg class="w-5 h-5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                </svg>
                <span class="font-medium flex-1 text-left">Master Data</span>
                <svg id="master-arrow" class="w-4 h-4 transition-transform duration-200 {{ $isMasterActive ? 'rotate-90' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                </svg>
            </button>

            <div id="master-menu" class="space-y-1 ml-4 {{ $isMasterActive ? '' : 'hidden' }}">
                ...
                <a href="{{ route('grade-supplier.index') }}"
                    ...
                    <span class="text-sm font-medium">Grading Supplier</span>
                </a>
                ...
                <a href="{{ route('grade-company.index') }}"
                    ...
                    <span class="text-sm font-medium">Grading Perusahaan</span>
                </a>
                ...
                <a href="{{ route('parent-grade-companies.index') }}"
                    ...
                    <span class="text-sm font-medium">Parent Grade Company</span>
                </a>
                ...
                <a href="{{ route('locations.index') }}"
                    ...
                    <span class="text-sm font-medium">Data Lokasi</span>
                </a>
            </div>
        </div>
